...
SRC_FILES = main env parsing tokenize tokenize_utils loop execution_cmd execution_builtins handle_env_vars lst_utils lst_modif \
			utils_print signals pipe child free\
